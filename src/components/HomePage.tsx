    ...
    <div className="flex flex-col min-h-screen bg-quicktok-black text-quicktok-white">
      ...
      <section className="hero-gradient py-24 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Create engaging TikTok-style videos with AI-generated scripts, realistic voices, and customizable visuals. Start now with 100 free credits!
          </motion.p>
          ...
          <motion.button
            ...
            whileHover={{ y: -5 }}
          >
            {user ? "Get Started Now" : "Sign Up Now - Free 100 Credits!"}
          </motion.button>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mt-16">
            <motion.button
              ...
              whileHover={{ y: -5 }}
            >
              {user ? "Create Your First Video" : "Get Started with 100 Free Credits"}
            </motion.button>
          </div>
        </div>
      </section>
